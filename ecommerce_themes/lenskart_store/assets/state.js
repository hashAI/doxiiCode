...
const trendingSearches = [
    ...
    { id: 'home-service', label: 'lenskart@home', icon: '🏠', bgColor: 'bg-purple-50' },
    { id: 'exchange', label: 'lenskart exchange', icon: '🔄', bgColor: 'bg-amber-50' },
...
class ThemeStore {
    constructor() {
        this.storageKey = 'lenskart-theme';
...
class ShortlistStore {
    constructor() {
        this.storageKey = 'lenskart-favorites';
        this.items = this.loadFromStorage();
        this.subscribers = [];
    }
