...
function render404() {
    ...
    app.innerHTML = `
        <div class="min-h-[60vh] flex flex-col items-center justify-center text-center space-y-4 px-6">
            <h1 class="text-6xl font-display font-bold text-gold">404</h1>
            <p class="text-gray-400 max-w-md">
                Oops! This page doesn't exist. Let's get you back to our exquisite collection.
            </p>
            <a href="#/" class="px-6 py-3 bg-gold text-black rounded-lg hover:bg-gold-light transition-colors touch-feedback font-semibold">
                Go home
            </a>
        </div>
    `;
