...
function render404() {
    ...
    app.innerHTML = `
        <div class="min-h-[60vh] flex flex-col items-center justify-center text-center space-y-4 px-6">
            <p class="text-sm uppercase tracking-[0.3em] text-slate-400">Store Name</p>
            <h1 class="text-5xl font-display text-slate-900 dark:text-white">404</h1>
            <p class="text-slate-500 dark:text-slate-300 max-w-md">
                Page not found. Let's get you back to explore the latest tech.
            </p>
            <a href="#/" class="px-6 py-3 bg-blue-600 text-white rounded-full hover:bg-blue-700 transition-colors">
                Go home
            </a>
        </div>
    `;
