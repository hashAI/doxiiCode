...
const initialProducts = [
    ...
    },
    {
        id: 6,
        name: 'iMac 24"',
        tagline: 'A desktop built for intelligent workflows.',
        price: 1299,
        category: 'Mac',
    ...
    // iPad
    {
        ...
        features: ['M4 chip', 'Ultra Retina XDR', 'Stylus Pro', 'Face ID'],
        colors: ['Space Black', 'Silver'],
        inStock: true,
        badge: 'New',
        rating: 4.9
    },
    {
        ...
        features: ['M3 chip', 'Liquid Retina display', 'Stylus Pro', 'Touch ID'],
    ...
    },
    {
        ...
        features: ['A14 Bionic', '10.9-inch display', 'USB-C', 'Stylus support'],
    ...
    // Watch
    {
        ...
        price: 399,
        category: 'Watch',
        image: getImageUrl('smart watch series 11', 1000, 0),
        heroImage: getImageUrl('smart watch fitness health', 1000, 1),
    ...
    },
    {
        ...
        price: 799,
        category: 'Watch',
        image: getImageUrl('smart watch ultra rugged', 1000, 2),
        heroImage: getImageUrl('smart watch diving ocean', 1000, 3),
        description: 'The most rugged and capable Smart Watch. Built for adventure with titanium case.',
    ...
    // Vision
    {
        ...
        price: 3499,
        category: 'Vision',
        image: getImageUrl('vision pro headset', 1000, 0),
    ...
    },
    {
        ...
        price: 129,
        category: 'Accessories',
        image: getImageUrl('stylus digital pen', 1000, 2),
        heroImage: getImageUrl('stylus drawing tablet', 1000, 3),
        description: 'The most advanced Stylus with squeeze gesture, barrel roll, and haptic feedback.',
...
export const categoriesMeta = [
    ...
    },
    {
        id: 'mac',
        name: 'Mac',
        description: 'Supercharged by powerful silicon',
    ...
    },
    {
        ...
        image: getImageUrl('smart watch collection', 1000, 3)
    },
    {
        id: 'airpods',
        name: 'AirPods',
    ...
    },
    {
        ...
        image: getImageUrl('vision pro', 1000, 5)
    },
    {
        id: 'accessories',
        name: 'Accessories',
        description: 'Mix. Match. MagSafe.',
        image: getImageUrl('accessories collection', 1000, 0)
    }
];
