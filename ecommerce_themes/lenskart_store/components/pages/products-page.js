...
import { productsStore, cartStore, userStore, frameShapes, categoriesMeta } from '../../assets/state.js';
                                    ...
                                    >
                                        ...
                                        <div class="flex-1 py-2">
                                            ...
                                            <div class="flex items-center gap-3 mt-4">
                                                ...
                                                >
                                                    <i data-lucide="heart" class="w-5 h-5 ${userStore.isInWishlist(product.id) ? 'fill-red-500 text-red-500' : 'text-gray-600 dark:text-gray-400'}"></i>
                                                </button>
                                            </div>
                                        </div>
                                    </a>
