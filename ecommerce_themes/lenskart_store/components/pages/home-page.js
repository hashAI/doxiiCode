...
import { productsStore, categoriesMeta, cartStore, userStore } from '../../assets/state.js';
...
class HomePage extends BaseComponent {
    ...
    toggleWishlist(productId, event) {
        event.preventDefault();
        event.stopPropagation();
        const isInWishlist = userStore.toggleWishlist(productId);
        showToast({
                        ...
                        <div class="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
                            ...
                            <div class="text-center lg:text-left order-2 lg:order-1">
                                ...
                                <p class="text-lg text-gray-300 mb-8 max-w-lg mx-auto lg:mx-0">
                                    Experience crystal clear vision with our premium collection of eyewear. Free home trial & 3D virtual try-on available.
                                </p>
                                <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                                    ...
                                    <a href="#/" class="inline-flex items-center justify-center gap-2 bg-white/10 hover:bg-white/20 text-white px-8 py-4 rounded-2xl font-semibold text-lg border border-white/20 transition-all">
                            ...
                            ${this.featuredProducts.slice(0, 8).map(product => this.html`
                                ...
                                >
                                    <div class="relative aspect-square bg-gray-100 dark:bg-slate-700 overflow-hidden">
                                        ...
                                        ` : ''}
                                        <button
                                            @click=${(e) => this.toggleWishlist(product.id, e)}
                                        ...
                                        >
                                            <i data-lucide="heart" class="w-4 h-4 ${userStore.isInWishlist(product.id) ? 'fill-red-500 text-red-500' : 'text-gray-600 dark:text-gray-400'}"></i>
                                        </button>
                    ...
                    <div class="container-desktop">
                        <div class="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
                            ${[
                                ...
                                { icon: 'home', title: 'Try at Home', desc: 'Book a free home visit' },
