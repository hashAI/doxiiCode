...
function render404() {
    ...
    app.innerHTML = `
        <div class="min-h-[60vh] flex flex-col items-center justify-center text-center space-y-4 px-6">
            <h1 class="text-6xl font-bold text-primary-900 dark:text-primary-200">404</h1>
            <p class="text-gray-500 dark:text-gray-400 max-w-md">
                Oops! This page doesn't exist. Let's get you back to shopping.
            </p>
            <a href="#/" class="px-6 py-3 bg-primary-900 text-white rounded-lg hover:bg-primary-800 transition-colors touch-feedback">
                Go home
            </a>
        </div>
    `;
