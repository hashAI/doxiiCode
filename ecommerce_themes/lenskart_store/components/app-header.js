                ...
                <div class="flex items-center justify-between px-4 py-3 border-b border-gray-100 dark:border-slate-800">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <a href="#/" class="flex items-center gap-2">
                            ...
                            <span class="font-display font-bold text-lg text-navy-900 dark:text-white">lenskart</span>
                        </a>
                    </div>
            ...
            <header class="hidden lg:block fixed top-0 left-0 right-0 z-50 bg-white dark:bg-slate-900 shadow-nav">
                ...
                <div class="border-b border-gray-100 dark:border-slate-800">
                    <div class="container-desktop flex items-center justify-between py-2">
                        ...
                        <div class="flex items-center gap-4 text-sm">
                            <a href="#/stores" class="text-gray-600 dark:text-gray-400 hover:text-brand-500 transition-colors">Store Locator</a>
                ...
                <div class="container-desktop flex items-center justify-between py-4">
                    ...
                    <a href="#/" class="flex items-center gap-3 group">
                        ...
                        <div>
                            <span class="font-display font-bold text-2xl text-navy-900 dark:text-white">lenskart</span>
                    ...
                    <!-- Actions -->
                    <div class="flex items-center gap-2">
                        <a href="#/" class="flex items-center gap-2 px-4 py-2.5 hover:bg-gray-100 dark:hover:bg-slate-800 rounded-xl transition-colors">
                            <i data-lucide="scan-face" class="w-5 h-5 text-brand-500"></i>
                            <span class="text-sm font-medium text-navy-900 dark:text-white">3D Try-On</span>
                        </a>
                ...
                <div class="border-t border-gray-100 dark:border-slate-800 bg-gray-50/50 dark:bg-slate-800/30">
                    <nav class="container-desktop">
                        <ul class="flex items-center gap-1">
                            ...
                            `)}
                            <li>
                                <a href="#/try-at-home" class="flex items-center gap-1.5 px-4 py-3 text-sm font-medium text-navy-900 dark:text-white hover:text-brand-500 transition-colors">
