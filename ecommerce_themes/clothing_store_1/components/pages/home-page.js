            ...
            <div class="relative">
                <div class="mx-auto max-w-6xl px-6 grid gap-10 lg:grid-cols-2 items-center">
                    <div class="space-y-6" data-aos="fade-up">
                        <p class="text-xs uppercase tracking-[0.4em] text-ink-400">Nova Threads</p>
                    ...
                    <div data-aos="fade-left">
                        <div class="relative">
                            <img src="${this.heroImage}" alt="Nova Threads editorial" class="rounded-[32px] shadow-glow object-cover w-full h-[520px]">
