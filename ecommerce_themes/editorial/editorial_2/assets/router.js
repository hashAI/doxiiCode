 ...
 * Reused from scaffold infrastructure but tweaked to also emit DOM events
 */
...
function render404() {
    ...
    app.innerHTML = `
        <div class="min-h-[60vh] flex flex-col items-center justify-center text-center space-y-4 px-6">
            <p class="text-sm uppercase tracking-[0.3em] text-ink-400">Store Name</p>
            <h1 class="text-5xl font-display text-ink-700 dark:text-white">404</h1>
            <p class="text-ink-500 dark:text-ink-100 max-w-md">
                We couldn't find the page you're after. Let's take you home to explore new drops.
            </p>
            <a href="#/" class="px-6 py-3 bg-ink-900 text-white rounded-full hover:bg-ink-700 transition-colors">
                Go home
            </a>
        </div>
    `;
