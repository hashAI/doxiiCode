                    ...
                    <div class="max-w-[1440px] mx-auto px-8 py-5 flex items-center gap-8">
                        ...
                        <a href="#/" @click=${() => navigate('/')} class="flex items-center gap-3 flex-shrink-0 group">
                            ...
                            <div class="leading-tight">
                                <p class="text-xl font-display font-semibold text-sand-900 dark:text-cream-50">Auréa</p>
                                <p class="text-xs text-sand-600 dark:text-cream-400">Contemporary Jewellery</p>
                            </div>
                        </a>
                        ...
                        <div class="flex-1 max-w-2xl">
                            <button
                                ...
                                <span class="text-sand-500 dark:text-stone-400 flex-1 text-left">Search for rings, necklaces, earrings...</span>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex items-center gap-2.5">
                                ...
                                <div class="leading-tight">
                                    <p class="text-sm font-display font-semibold text-sand-900 dark:text-cream-50">Auréa</p>
                                    <p class="text-xs text-sand-600 dark:text-cream-400">Jewellery</p>
                                </div>
                            </div>
                        </div>
